...
function ServiceCardSliderItem({ item, onClick, showButton }: Props) {
  const { content, subtitle, title } = item;
  return (
    <motion.div
      variants={hoverVariant}
      whileHover={"hover"}
      className="flex flex-col gap-y-1 p-5 w-full justify-center items-center rounded-[20px] bg-white md:h-[380px] shadow-lg "
    >
...
export default ServiceCardSliderItem;
